...
如果你想看模型架构的详细讲解、代码逐段解释，可以直接阅读：[doc/学习日志.md](doc/学习日志.md)。
如果想看完整的训练和微调流程及讲解，请阅读：[doc/训练及微调.md](doc/训练及微调.md)

另外，如果想看简单易懂的 Hot 100 题解，请阅读：[doc/hot100刷题.md](doc/hot100刷题.md)。
